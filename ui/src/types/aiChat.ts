/** Contratos del asistente conversacional Ponti (POST /v1/chat en Axis Companion vía BFF). */
...
/** Evento SSE de POST .../chat/stream (misma forma que emite Axis Companion). */
