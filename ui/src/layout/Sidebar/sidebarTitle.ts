...
const secondaryTitles = new Map<string, string>([
  ...
  ["/admin/database/tasks", "Crear"],
  ["/admin/database/tasks/list", "Editar"],
  ["/admin/database/tasks/archived", "Archivados"],
  ["/admin/database/items", "Crear"],
  ["/admin/database/items/list", "Editar"],
  ["/admin/database/supplies/archived", "Archivados"],
  ["/admin/products/archived", "Movimientos Archivados"],
