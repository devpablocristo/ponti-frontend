...
const menuDatabase: SubmenuGroup = {
  ...
  children: [
    ...
    { name: "Todos", route: "/admin/database/actors" },
    { name: "Clientes", route: "/admin/database/actors/clientes" },
    { name: "Inversores", route: "/admin/database/actors/inversores" },
    { name: "Responsables", route: "/admin/database/actors/responsables" },
    { name: "Proveedores", route: "/admin/database/actors/proveedores" },
    { name: "Contratistas", route: "/admin/database/actors/contratistas" },
    { name: "Duplicados", route: "/admin/database/actors/duplicates" },
