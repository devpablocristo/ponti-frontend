...
export function InvestorShareRow({ investors, surfaceTotalHa, adminPerHaUsd }: Props) {
  return (
    <section className="min-w-0 rounded-xl border bg-white p-2.5">
      <header className="mb-2.5 flex flex-wrap items-start justify-between gap-2.5">
        ...
        <div className="flex flex-wrap items-center gap-1.5 rounded-xl border bg-white px-2 py-1">
          <div className="flex items-center gap-1.5">
            <span className="text-[0.72rem] text-slate-600 whitespace-nowrap">Superficie</span>
            <span className="inline-flex rounded-lg border bg-[#F8FAFC] px-1.5 py-0.5 text-[0.72rem] font-semibold text-slate-900 tabular-nums">
              {formatNumberAr(surfaceTotalHa)} Ha
            </span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="text-[0.72rem] text-slate-600 whitespace-nowrap">Admin. proyecto / Ha</span>
            <span className="inline-flex rounded-lg border bg-[#F8FAFC] px-1.5 py-0.5 text-[0.72rem] font-semibold text-slate-900 tabular-nums">
