...
/**
 * Header del DataTable de Labors: botón "Configurar Columnas" + modal con
 * checkboxes para visibilidad por columna. Estado local (showColumnsModal)
 * no propaga al parent. Patrón equivalente al OrdersHeader de workorders.
 */
export function LaborsHeader({
  selectedColumns,
  setSelectedColumns,
  setVisibleColumns,
  allColumns,
