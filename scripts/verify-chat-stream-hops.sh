...
# Uso: desde repo ponti-frontend, con backend y BFF levantados:
#   BASE_MANAGER_API=http://localhost:8080/api/v1 BFF_URL=http://localhost:3000 ./scripts/verify-chat-stream-hops.sh
...
echo "== Paso 1 (100%): backend alcanzable — GET ${BASE_MANAGER_API%/}/ping =="
